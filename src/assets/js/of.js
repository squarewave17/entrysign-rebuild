...
(function (global, factory) {
  ...
  function isFocusable(element) {
    return (
      isInput(element) ||
      matches(element, "a[href],button") ||
      hasAttr(element, "tabindex")
    );
  }
  ...
  var parseCssVar = memoize(function (name) {
    /* usage in css: .of-name:before { content:"xyz" } */
  ...
  function getCssVar(name) {
    return !isIE
      ? getStyles(document.documentElement).getPropertyValue("--of-" + name)
      : parseCssVar(name);
  }
        ...
        return new Promise$1(function (resolve, reject) {
          ...
          once(
            ...
            function (ref) {
              ...
              clearTimeout(timer);
              removeClass(element, "of-transition");
              css(element, {
                transitionProperty: "",
                transitionDuration: "",
          ...
          addClass(element, "of-transition");
          css(
            element,
            assign(
              {
  ...
  var Transition = {
    ...
    inProgress: function (element) {
      return hasClass(element, "of-transition");
    },
  };

  var animationPrefix = "of-animation-";
      ...
      toNodes(element).map(function (element) {
        return new Promise$1(function (resolve, reject) {
          ...
          if (startsWith(animation, animationPrefix)) {
            origin && addClass(element, "of-transform-origin-" + origin);
  ...
  var getComponentName = memoize(function (attribute) {
    return startsWith(attribute, "of-") || startsWith(attribute, "data-of-")
      ? camelize(attribute.replace("data-of-", "").replace("of-", ""))
      : false;
  });
  ...
  function Core(ofkit) {
    ...
    on(
      ...
      function (ref) {
        ...
        if ((css(target, "animationName") || "").match(/^of-.*(left|right)/)) {
          started++;
  ...
  var Togglable = {
    ...
    data: {
      ...
      origin: false,
      transition: "linear",
      clsEnter: "of-togglabe-enter",
      clsLeave: "of-togglabe-leave",
  ...
  var Accordion = {
    ...
    data: {
      ...
      multiple: false,
      clsOpen: "of-open",
      toggle: "> .of-accordion-title",
      content: "> .of-accordion-content",
      transition: "ease",
      offset: 0,
    },
  ...
  var drop = {
    ...
    computed: {
      ...
      clsDrop: function (ref) {
        ...
        return clsDrop || "of-" + this.$options.name;
      },
  ...
  var Margin = {
    ...
    data: {
      margin: "of-margin-small-top",
      firstColumn: "of-first-column",
    },
  ...
  var grid = {
    ...
    data: {
      margin: "of-grid-margin",
      clsStack: "of-grid-stack",
      masonry: false,
      parallax: 0,
    },

    connected: function () {
      this.masonry && addClass(this.$el, "of-flex-top of-flex-wrap-top");
    },
    ...
    methods: {
      getSvg: function () {
        ...
        return loadSVG(this.src).then(function (svg) {
          return (
            parseSVG(svg, this$1.icon) || Promise$1.reject("SVG not found.")
          );
        });
      },
  ...
  function applyAnimation(el) {
    ...
    if (length) {
      el.style.setProperty("--of-animation-stroke", length);
    }
  }
  ...
  var Slidenav = {
    ...
    computed: {
      icon: function (ref, $el) {
        ...
        return hasClass($el, "of-slidenav-large") ? icon + "-large" : icon;
      },
    },
  };
  ...
  var Search = {
    ...
    computed: {
      icon: function (ref, $el) {
        ...
        return hasClass($el, "of-search-icon") &&
          parents($el, ".of-search-large").length
          ? "search-large"
          : parents($el, ".of-search-navbar").length
          ? "search-navbar"
          : icon;
      },
    },
  ...
  var Close = {
    ...
    computed: {
      icon: function () {
        return (
          "close-" + (hasClass(this.$el, "of-close-large") ? "large" : "icon")
        );
      },
    },
  };
  ...
  var leader = {
    ...
    data: {
      fill: "",
      clsWrapper: "of-leader-fill",
      clsHide: "of-leader-hide",
      attrFill: "data-fill",
    },
  ...
  var modal = {
    ...
    data: {
      clsPage: "of-modal-page",
      selPanel: ".of-modal-dialog",
      selClose:
        ".of-modal-close, .of-modal-close-default, .of-modal-close-outside, .of-modal-close-full",
    },
    ...
    events: [
      {
        ...
        handler: function () {
          if (hasClass(this.panel, "of-margin-auto-vertical")) {
            addClass(this.$el, "of-flex");
          } else {
  ...
  function install$2(ref) {
    ...
    modal.dialog = function (content, options) {
      var dialog = modal(
        '<div class="of-modal"> <div class="of-modal-dialog">' +
          content +
          "</div> </div>",
        options
      );
      ...
      return openDialog(
        function (ref) {
          ...
          return (
            ...
            '</div> <div class="of-modal-footer of-text-right"> <button class="of-button of-button-primary of-modal-close" autofocus>' +
            labels.ok +
            "</button> </div>"
          );
        },
    ...
    modal.confirm = function (message, options) {
      return openDialog(
        function (ref) {
          ...
          return (
            '<form> <div class="of-modal-body">' +
            (isString(message) ? message : html(message)) +
            '</div> <div class="of-modal-footer of-text-right"> <button class="of-button of-button-default of-modal-close" type="button">' +
            labels.cancel +
            '</button> <button class="of-button of-button-primary" autofocus>' +
            labels.ok +
            "</button> </div> </form>"
          );
        },
    ...
    modal.prompt = function (message, value, options) {
      return openDialog(
        function (ref) {
          ...
          return (
            '<form class="of-form-stacked"> <div class="of-modal-body"> <label>' +
            (isString(message) ? message : html(message)) +
            '</label> <input class="of-input" value="' +
            (value || "") +
            '" autofocus> </div> <div class="of-modal-footer of-text-right"> <button class="of-button of-button-default of-modal-close" type="button">' +
            labels.cancel +
            '</button> <button class="of-button of-button-primary">' +
            labels.ok +
            "</button> </div> </form>"
          );
        },
      ...
      dropbar: {
        get: function (ref) {
          ...
          dropbar =
            ...
            $("+ .of-navbar-dropbar", this.$el);

          return dropbar ? dropbar : (this._dropbar = $("<div></div>"));
        },

        watch: function (dropbar) {
          addClass(dropbar, "of-navbar-dropbar");
        },
...

      {
        ...
        handler: function (_, ref) {
          ...
          if (this.dropbarMode === "slide") {
            addClass(this.dropbar, "of-navbar-dropbar-slide");
          }
  ...
  var offcanvas = {
    ...
    data: {
      ...
      flip: false,
      overlay: false,
      clsPage: "of-offcanvas-page",
      clsContainer: "of-offcanvas-container",
      selPanel: ".of-offcanvas-bar",
      clsFlip: "of-offcanvas-flip",
      clsContainerAnimation: "of-offcanvas-container-animation",
      clsSidebarAnimation: "of-offcanvas-bar-animation",
      clsMode: "of-offcanvas",
      clsOverlay: "of-offcanvas-overlay",
      selClose: ".of-offcanvas-close",
      container: false,
    },
  ...
  var overflowAuto = {
    ...
    data: {
      selContainer: ".of-modal",
      selContent: ".of-modal-dialog",
    },
  ...
  var responsive = {
    ...
    connected: function () {
      addClass(this.$el, "of-responsive-width");
    },
  ...
  var scrollspy = {
    ...
    data: function () {
      return {
        ...
        repeat: false,
        delay: 0,
        inViewClass: "of-scrollspy-inview",
      };
    },
    ...
    update: [
      {
        read: function (data$1) {
          ...
          this.elements.forEach(function (el) {
            if (!el[stateKey]) {
              el[stateKey] = {
                cls: data(el, "of-scrollspy-class") || this$1.cls,
              };
            }

            el[stateKey].show = isInView(
              el,
              this$1.offsetTop,
              this$1.offsetLeft
            );
        ...
        write: function (data) {
          ...
          this.elements.forEach(function (el) {
            ...
            if (state.show && !state.inview && !state.queued) {
              ...
              data.promise = (data.promise || Promise$1.resolve())
                .then(function () {
                  return new Promise$1(function (resolve) {
  ...
  var sticky = {
    ...
    data: {
      ...
      clsActive: "of-active",
      clsInactive: "",
      clsFixed: "of-sticky-fixed",
      clsBelow: "of-sticky-below",
      selTarget: "",
      widthElement: false,
      showOnUp: false,
      targetOffset: false,
    ...
    connected: function () {
      this.placeholder =
        $("+ .of-sticky-placeholder", this.$el) ||
        $('<div class="of-sticky-placeholder"></div>');
      this.isFixed = false;
      this.isActive = false;
    },
      ...
      toggles: {
        get: function (ref, $el) {
          ...
          return $$(toggle, $el).filter(function (el) {
            return !matches(el, ".of-disabled *, .of-disabled, [disabled]");
          });
        },
  ...
  var tab = {
    ...
    data: {
      media: 960,
      attrItem: "of-tab-item",
    },

    connected: function () {
      var cls = hasClass(this.$el, "of-tab-left")
        ? "of-tab-left"
        : hasClass(this.$el, "of-tab-right")
        ? "of-tab-right"
        : false;
    ...
    events: [
      {
        ...
        handler: function (e) {
          if (!isTouch(e)) {
            this.toggle(
              "toggle" +
                (includes([pointerEnter, "focus"], e.type) ? "show" : "hide")
            );
          }
        },
      },
  ...
  var clsLeave = "of-transition-leave";
  var clsEnter = "of-transition-enter";
  ...
  var Slideshow = {
    ...
    data: {
      animation: "slide",
      clsActivated: "of-transition-active",
  ...
  var LightboxPanel = {
    ...
    data: function () {
      return {
        ...
        items: [],
        cls: "of-open",
        clsPage: "of-lightbox-page",
        selList: ".of-lightbox-items",
        attrItem: "of-lightbox-item",
        selClose: ".of-close-large",
        selCaption: ".of-lightbox-caption",
        pauseOnHover: false,
        velocity: 2,
        Animations: Animations$1,
        template:
          '<div class="of-lightbox of-overflow-hidden"> <ul class="of-lightbox-items"></ul> <div class="of-lightbox-toolbar of-position-top of-text-right of-transition-slide-top of-transition-opaque"> <button class="of-lightbox-toolbar-icon of-close-large" type="button" of-close></button> </div> <a class="of-lightbox-button of-position-center-left of-position-medium of-transition-fade" href of-slidenav-previous of-lightbox-item="previous"></a> <a class="of-lightbox-button of-position-center-right of-position-medium of-transition-fade" href of-slidenav-next of-lightbox-item="next"></a> <div class="of-lightbox-toolbar of-lightbox-caption of-position-bottom of-text-center of-transition-slide-bottom of-transition-opaque"></div> </div>',
      };
    },
    ...
    events: [
...

      {
        ...
        handler: function (_, item) {
          ...
          this.setItem(item, "<span of-spinner></span>");
    ...
    methods: {
      ...
      setError: function (item) {
        this.setItem(item, '<span of-icon="icon: bolt; ratio: 2"></span>');
      },
      ...
      showControls: function () {
        ...
        addClass(this.$el, "of-active", "of-transition-active");
      },

      hideControls: function () {
        removeClass(this.$el, "of-active", "of-transition-active");
      },
    },
  };
    ...
    events: [
      {
        ...
        delegate: function () {
          return this.toggle + ":not(.of-disabled)";
        },
  ...
  var notification = {
    ...
    data: {
      ...
      group: null,
      pos: "top-center",
      clsContainer: "of-notification",
      clsClose: "of-notification-close",
      clsMsg: "of-notification-message",
    },
  ...
  function Transitioner(prev, next, dir, ref) {
    ...
    return {
      ...
      getItemIn: function (out) {
        ...
        return nextActives[
          findIndex(nextActives, function (el) {
  ...
  var slider = {
    ...
    data: {
      center: false,
      sets: false,
      attrItem: "of-slider-item",
      selList: ".of-slider-items",
      selNav: ".of-slider-nav",
      clsContainer: "of-slider-container",
    ...
    computed: {
      ...
      sets: function (ref) {
        ...
        sets = sortBy$1(this.slides, "offsetLeft").reduce(function (
          sets,
          slide,
          i
        ) {
  ...
  var slideshow = {
    ...
    data: {
      ...
      minHeight: false,
      maxHeight: false,
      selList: ".of-slideshow-items",
      attrItem: "of-slideshow-item",
      selNav: ".of-slideshow-nav",
  ...
  var sortable = {
    ...
    data: {
      group: false,
      threshold: 5,
      clsItem: "of-sortable-item",
      clsPlaceholder: "of-sortable-placeholder",
      clsDrag: "of-sortable-drag",
      clsDragState: "of-drag",
      clsBase: "of-sortable",
      clsNoDrag: "of-sortable-nodrag",
      clsEmpty: "of-sortable-empty",
      clsCustom: "",
      handle: false,
      pos: {},
    },
  ...
  var tooltip = {
    ...
    data: {
      ...
      title: "",
      delay: 0,
      animation: ["of-animation-scale-up"],
      duration: 100,
      cls: "of-active",
      clsPos: "of-tooltip",
    },
